  ...
  return (
    <View style={{ flex: 1, alignItems: "center" }}>
      <View style={{ alignItems: "center", marginTop: 20 }}>
        ...
        <Text>Sedang melaksanakan</Text>
        <Text>{title}</Text>
      </View>
      <View style={{ marginTop: 20, width: 300 }}>
        <Text style={{ marginBottom: 10, fontSize: 15, fontWeight: "bold" }}>Masukan Text</Text>
        <TextInput  style={{ borderRadius: 5, borderWidth: 1, padding: 11 }} placeholder="Input Your Text" defaultValue={title} onChangeText={(text) => setTitle(text)} />
      </View>
